		...
		<div class="col-md-12 column">
			...
			<form class="form-horizontal">
				<div class="form-group">
					...
					<div class="col-sm-6">
						<input type="number" class="form-control inputname" id="inputPhone3" name="username" title="提示"
							   data-container="body" data-toggle="popover" data-placement="top" data-content="请输入11位手机号"/>
					</div>
				</div>
				<div class="form-group">
